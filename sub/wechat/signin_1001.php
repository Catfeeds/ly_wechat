...
<form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
    ...
    <div id="page_1">
    	...
    	<p style="text-align:center;padding-top:10px;font-size:16px;font-weight:bold">
			您好！欢迎来到2016迪拜年度邮轮路演
		</p>
		<div class="item">
			<div class="detail" id="detail">
			<?php echo($a_act1->getLocation().'站现场');?>
			</div>
		</div>
		<p style="text-align:center;padding-top:5px;font-size:22px;font-weight:bold">
		<?php 
		if ($count>0)
		{
			echo('请核对您的个人信息，谢谢！');
    	...
    	<div class="input" style="margin-top:22px;padding-bottom:25px;margin-left:5%;width:90%;">
    	   <button type="button" onclick="submit_info()" style="background-image:url('images/activity/1001_but_icon_01.png');background-position: left center;background-repeat: no-repeat;">确认签到</button>
    	</div>
	</div>
</form>
