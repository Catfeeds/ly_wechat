...
<body>
    <div id="page_1">
        <div style="">
    		<img src="images/activity/<?php echo($_GET['id'])?>_reg_top.jpg"/> 
    	</div>
    	<p style="text-align:center;padding-top:30px;font-size:20px;font-weight:bold;color:black;color:#3A3A3A;">
			签到成功，谢谢！<br/>
（请向工作人员提交名片后入场）
		</p>
	</div>
