...
<form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
    ...
    <div id="page_1">
    	...
    	<div style="float:left;margin-top:-80px;">
			<div style="margin-left:8%;margin-right:8%;width:auto;color:#004EA2;font-size:24px;line-height:30px;text-align:center;padding-top:15px;">
				<strong><span>修改报名信息</span></strong>
			</div>
		</div>
    	<div style="margin-top:0px;">
	    	...
	    	<div class="input" style="margin-top:22px;padding-bottom:25px;margin-left:5%;width:90%;">
	    	   <button type="button" onclick="submit_info()">保存修改</button>
	    	</div>
    	</div>
	</div>
</form>
