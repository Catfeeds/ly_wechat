    ...
    <style type="text/css">
			...
			*
			...
			.line
			{
				...
				width:90%;
				margin-left:5%;
				border-bottom: 1px solid #101E3B;
				border-left: 1px solid #101E3B;
				border-right: 1px solid #101E3B;
			}
...
<form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
    ...
    <input type="hidden" name="Vcl_Reg" id="Vcl_Reg" value="0"/>
    ...
    <div id="page_1">
        <div>
    		<img src="images/activity/1027_reg_top.jpg"/>
    	</div>
    	...
    	<div class="input" style="margin-top:12px;padding-bottom:25px;margin-left:5%;width:90%;">
...
<script type="text/javascript">
	...
	get_user_temp_info(document.getElementById("Vcl_Phone"))
	</script>
