...
$o_activity->PushWhere(array("&&", "Id", "=",'1076'));
...
<body>
    <div id="page_1">
        <div>
    		<img src="../images/activity/1076_reg_top.jpg"/>
    	</div>
    	<p style="text-align:center;padding-top:50px;font-size:25px;font-weight:bold;color:black;color:#3A3A3A">
			<?php echo($s_text)?>
		</p>
	</div>
