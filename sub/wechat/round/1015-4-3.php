...
<body>
<img src="../images/round/1015_top.jpg" style="width:100%"/>
<div class="body">
	<div class="userphoto">
		<?php echo($s_photo)?>
	</div>
</div>
<nav class="navbar navbar-fixed-bottom footer" style="margin-bottom: 5px;">
	...
	<div class="button">
		<div class="next" onclick="location='round-4-3.php?id=<?php echo(($id+1))?>'">
