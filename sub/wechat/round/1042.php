...
<body>
<div class="top">
	<div class="title"><img src="images/1042_title.png" /></div>
	<div class="logo"><img src="images/1042_logo.png" /></div>
</div>
<div class="body">
...
<nav class="navbar navbar-fixed-bottom footer" style="margin-bottom: 20px;">
	<div class="button">
		<div class="stop" onclick="stop()">
			<img src="images/1042_stop.png"/>
		</div>
		<div class="save" onclick="save()">
			<img src="images/1042_save.png"/>
		</div>
		<div class="goon" onclick="start()">
			<img src="images/1042_play.png"/>
		</div>		
	</div>
</nav>
<script type="">
