...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<div style="background-color:white;">
		<img src="images/1027_partner2_logo.jpg"/>
	</div>
	<div class="question">
	...
	<div class="question">
		<div style="margin-top:20px;" id="A" class="select" onclick="selected(this,'A')" style="margin-top:40px;">A. 枫糖制品</div>
		<div id="B" class="select" onclick="selected(this,'B')">B. 棉绒制品</div>
		<div id="C" class="select" onclick="selected(this,'C')">C. 蔓越莓制品</div>
		<div id="D" class="select" onclick="selected(this,'D')">D. 苹果冰酒</div>
