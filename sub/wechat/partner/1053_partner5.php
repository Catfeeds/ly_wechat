...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<div class="question" style="background-color:white;">
		...
		<div class="item">
		以下哪个城市还没有开通去往吉隆坡的常规直飞航班？
		</div>
	</div>
	<div class="question">
		<div id="A" class="select" onclick="selected(this,'A')" style="margin-top:40px;">A. 重庆</div>
		<div id="B" class="select" onclick="selected(this,'B')">B. 昆明</div>
		<div id="C" class="select" onclick="selected(this,'C')">C. 贵阳</div>
		<div id="D" class="select" onclick="selected(this,'D')">D. 西安</div>
