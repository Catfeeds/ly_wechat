...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<div class="question" style="background-color:white;">
		...
		<div class="item">
		以下国际五星级酒店品牌中，即将建成开业的酒店是：
		</div>
	</div>
	<div class="question">
		<div id="A" class="select" onclick="selected(this,'A')" style="margin-top:40px;">A. 四季</div>
		<div id="B" class="select" onclick="selected(this,'B')">B. 瑞吉</div>
		<div id="C" class="select" onclick="selected(this,'C')">C. 丽思卡尔顿</div>
		<div id="D" class="select" onclick="selected(this,'D')">D. 艾美</div>
