...
<head>
	...
	<meta name="description" id="metaDescription" content="抢答题 第一题">
...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<div style="margin-top:0px;background-image:url('../images/activity/1080_reg_bj.jpg');background-repeat:no-repeat;background-size:100%;">
		<div class="question">
			...
			1.<br/>
			同样天数的英爱产品，哪家航空公司在爱尔兰停留的时间最长？
			</div>
		</div>
		<div class="question">
			<div id="A" class="select" onclick="selected(this,'A')" style="margin-top:0px">A. 芬兰航空</div>
			<div id="B" class="select" onclick="selected(this,'B')">B. 卡塔尔</div>
			<div id="C" class="select" onclick="selected(this,'C')">C. 天津航班</div>
