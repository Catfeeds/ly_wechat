...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<div class="question">
		<div id="A" class="select" onclick="selected(this,'A')" style="margin-top:40px;">A. 康华利堡</div>
		<div id="B" class="select" onclick="selected(this,'B')">B. 龙山堂邱公司</div>
		<div id="C" class="select" onclick="selected(this,'C')">C. 瑟福屋</div>
		<div id="D" class="select" onclick="selected(this,'D')">D. 坎贝尔之家</div>
