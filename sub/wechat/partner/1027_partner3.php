...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<div style="background-color:white;">
		<img src="images/1027_partner3_logo.jpg"/>
	</div>
	<div class="question">
		<img src="images/1027_title_logo.jpg"/>
		<div class="title">
		Saint-Félicien野生动物园的过夜打包产品名字是？
		</div>
	</div>
	<div class="question">
		<div style="margin-top:20px;" id="A" class="select" onclick="selected(this,'A')" style="margin-top:40px;">A. 大象世界</div>
		<div id="B" class="select" onclick="selected(this,'B')">B. 狼世界</div>
		<div id="C" class="select" onclick="selected(this,'C')">C. 驯鹿世界</div>
		<div id="D" class="select" onclick="selected(this,'D')">D. 峡湾怪物世界</div>
