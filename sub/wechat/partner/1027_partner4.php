...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<div style="background-color:white;">
		<img src="images/1027_partner4_logo.jpg"/>
	</div>
	<div class="question">
		<img src="images/1027_title_logo.jpg"/>
		<div class="title">
		一年四季都停留在圣劳伦斯河中的哺乳动物是？
		</div>
	</div>
	<div class="question">
		<div style="margin-top:20px;" id="A" class="select" onclick="selected(this,'A')" style="margin-top:40px;">A. 白鲸</div>
		<div id="B" class="select" onclick="selected(this,'B')">B. 虎鲨</div>
		<div id="C" class="select" onclick="selected(this,'C')">C. 海豹</div>
		<div id="D" class="select" onclick="selected(this,'D')">D. 海豚</div>
