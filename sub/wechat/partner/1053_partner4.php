...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<div class="question">
		<div id="A" class="select" onclick="selected(this,'A')" style="margin-top:40px;">A. 古晋圆形剧场</div>
		<div id="B" class="select" onclick="selected(this,'B')">B. 古晋婆罗洲会展中心</div>
		<div id="C" class="select" onclick="selected(this,'C')">C. Damai Centre</div>
		<div id="D" class="select" onclick="selected(this,'D')">D. 砂拉越文化村</div>
