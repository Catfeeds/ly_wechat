...
<head>
	...
	<meta name="description" id="metaDescription" content="抢答题 第二题">
...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<div style="margin-top:0px;background-image:url('../images/activity/1080_reg_bj.jpg');background-repeat:no-repeat;background-size:100%;">
		<div class="question">
			...
			2.<br/>
			以下哪一个景点为北爱尔兰唯一一处联合国科教文组织认证的世界遗产？
			</div>
		</div>
		<div class="question">
			<div id="A" class="select" onclick="selected(this,'A')" style="margin-top:0px">A. 卡里克索桥</div>
			<div id="B" class="select" onclick="selected(this,'B')">B. 邓陆斯城堡</div>
			<div id="C" class="select" onclick="selected(this,'C')">C. 穆森登神庙</div>
			<div id="D" class="select" onclick="selected(this,'D')">D. 巨人堤</div>
