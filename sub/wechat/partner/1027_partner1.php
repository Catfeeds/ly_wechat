...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<div style="background-color:white;">
		<img src="images/1027_partner1_logo.jpg"/>
	</div>
	<div class="question">
		<img src="images/1027_title_logo.jpg"/>
		<div class="title">
		以下哪一个地点是四季皆宜的旅游目的地，同时连续18年被滑雪杂志《SKI Magazine》读者评为北美东部最佳滑雪度假村？
		</div>
	</div>
	<div class="question">
		<div style="margin-top:20px;" id="A" class="select" onclick="selected(this,'A')" style="margin-top:40px;">A. 棕榈崖度假村</div>
		<div id="B" class="select" onclick="selected(this,'B')">B. 尼莫湾度假村</div>
		<div id="C" class="select" onclick="selected(this,'C')">C. 杰克逊尔山度假村</div>
		<div id="D" class="select" onclick="selected(this,'D')">D. 汤卜朗山度假村</div>
