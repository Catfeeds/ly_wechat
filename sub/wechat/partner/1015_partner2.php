...
<html lang="zh-CN">
<head>
    <title>有奖问答-第二题 </title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0"/>
	<meta name="description" id="metaDescription" content="有奖问答-第二题">
...
<form action="../include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
	...
	<input type="hidden" name="Vcl_Question" id="Vcl_Question" value="2"/>
	...
	<div class="question" style="background-color:white;">
		...
		<div class="item">
		有时尚的外观，一流的设施的兰卡威国际会议中心（LICC）可提供容纳多少人的宴会场地？
		</div>
	</div>
	<div class="question">
		<div id="A" class="select" onclick="selected(this,'A')" style="margin-top:40px;">A. 300</div>
		<div id="B" class="select" onclick="selected(this,'B')">B. 400</div>
		<div id="C" class="select" onclick="selected(this,'C')">C. 500</div>
		<div id="D" class="select" onclick="selected(this,'D')">D. 1000</div>
...
if ($o_user->getAllCount()>0)
{
	...
	if ($o_activity->getAllCount()>0)
	{
		...
		{
			if ($o_user_activity_join->getAnswer2(0)!='0')
			{
				//说明已经答过
				?>
				...
				$('#<?php echo($o_user_activity_join->getAnswer2(0))?>').addClass("on error");
