...
<form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
    ...
    <div id="page_1">
		...
		<div class="item">
			<div class="box" onclick="change_location(1001)">
				<div class="box1">
					<div id="1001"></div>
				</div>
				&nbsp;&nbsp;广州
			</div>
			<div class="box" onclick="change_location(1002)">
				<div class="box1">
					<div id="1002"></div>
				</div>
				&nbsp;&nbsp;北京
			</div>
			<div class="box" onclick="change_location(1003)">
				<div class="box1">
					<div id="1003"></div>
				</div>
				&nbsp;&nbsp;上海
...
<script type="text/javascript">
	...
	<?php 
	$a_act1=new WX_Activity(1001);
	$a_act2=new WX_Activity(1002);
	$a_act3=new WX_Activity(1003);
	?>
	var local = {
		    1001:'<?php echo($a_act1->getLocation().'站：'.$a_act1->getActivityDate().'（周'.$a_act1->getWeek().'）'.$a_act1->getActivityTime());?>',
		    1002:'<?php echo($a_act2->getLocation().'站：'.$a_act2->getActivityDate().'（周'.$a_act2->getWeek().'）'.$a_act2->getActivityTime());?>',
		    1003:'<?php echo($a_act3->getLocation().'站：'.$a_act3->getActivityDate().'（周'.$a_act3->getWeek().'）'.$a_act3->getActivityTime());?>',
	}
	<?php 
	echo('
	...
	function change_location(id)
	{
		...
		document.getElementById("1001").className="";
		document.getElementById("1002").className="";
		document.getElementById("1003").className="";
...
<div class="weui_dialog_alert" id="success" style="display:none;">
    <div class="weui_mask" style="background:rgba(0,145,244,.9)"></div>
    <div class="weui_dialog_loading">
    ...
    感谢您的支持和关注！<br/><br/><br/>
<img src="images/activity/1001_box_icon_02.png" style="width:25%;"/>
    </div>
</div>
