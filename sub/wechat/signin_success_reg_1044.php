...
<body>
    <div id="page_1">
        <div>
    		<img src="images/activity/1044_sign_top.jpg"/>
    	</div>
    	<p style="text-align:center;padding-top:60px;line-height:40px;font-size:25px;font-weight:bold;color:black;color:#E40521">
			恭喜您，现场注册成功！
		</p>
	</div>
