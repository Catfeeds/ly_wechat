...
<form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
    ...
    <div id="page_1">
    	...
    	<div style="float:left;margin-top:-80px;">
			<div style="margin-left:8%;margin-right:8%;width:auto;color:#004EA2;font-size:24px;line-height:30px;text-align:center;">
				<strong><span>重庆站 2017.5.19</span><br/>
				<span style="font-size:16px;">Chongqing Station, May 19th, 2017</span></strong><br/>
				<span style="font-size:18px;">时间：9:00-13:00</span>
			</div>
		</div>
...
<div class="weui_dialog_alert" id="success" style="display:none">
    <div class="weui_mask" style="background:rgba(0,78,162,.9)"></div>
    <div class="weui_dialog_loading">
