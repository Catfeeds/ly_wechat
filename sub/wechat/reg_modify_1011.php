...
<form action="include/bn_submit.switch.php" id="submit_form" method="post" target="submit_form_frame">
    ...
    <div id="page_1">
    	...
    	<p style="text-align:center;padding-top:10px;padding-bottom:10px;font-size:20px;font-weight:bold;background-color:#EFEEEA;overflow:hidden;">
		...
		<div class="item">
			...
			<?php echo($a_act1->getLocation().'站：'.$a_act1->getActivityDate().'（周'.$a_act1->getWeek().'）');?>
			</div>
		</div>
    	...
    	<div class="input" style="margin-top:22px;padding-bottom:25px;margin-left:5%;width:90%;">
    	   <button type="button" onclick="submit_info()">提交</button>
    	</div>
	</div>
</form>
